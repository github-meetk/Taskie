            ...
            <div className="flex items-center">
              ...
              {token && (
                <button
                  ...
                  className="text-white bg-[#2557D6] hover:bg-[#2557D6]/90 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#2557D6]/50 mb-2"
                >
                  Logout
                </button>
              )}
